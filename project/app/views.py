...
def home(request):
    ...
    # data0=Student.objects.filter(id=1,stu_city='Bhopal')
    # print(data0)
    # print("SQL Query :", data0.query)
    ...
    # data0=Student.objects.order_by('stu_name').order_by('stu_city').order_by('-stu_email')
    # data0=Student.objects.order_by('-stu_email')
    # data0=Student.objects.order_by('stu_city')
    # data0=Student.objects.order_by('-stu_city')
    # print(data0)
    # print("SQL Query :", data0.query)
    # return render(request,'app/home.html',{'data0':data0})
